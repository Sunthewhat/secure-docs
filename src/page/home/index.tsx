...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col">
      {/* top bar */}
      <div className="font-noto shadow-md bg-primary_background rounded-[15px] flex flex-row justify-between items-center w-full h-full px-[20px]">
        <div className="px-[25px] py-[50px]">
          <p className="font-bold text-[25px] w-fit text-primary_text">Collections</p>
        </div>
      ...
      {/* grid */}
      <div className="font-noto bg-gray-300/90 rounded-[15px] flex flex-col items-center w-full min-h-[770px] px-[20px] mt-[25px] py-[20px]">
...
function Card({
  ...
  return (
    <div className="bg-gray-200 rounded-[10px] w-full aspect-square flex flex-col px-5 py-5 items-center border border-black-900">
