...
const HistoryPage = () => {
  ...
  useEffect(() => {
    ...
    // Example: Axios.get(`/history/${certId}`)
        ...
        <div className="flex justify-between h-[120px]">
          ...
          <div className="w-[225px] flex-col">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="text-noto font-bold text-[14px] bg-primary_button text-secondary_text rounded-[10px] h-[39px] px-6 flex justify-between items-center">
                <p>Revoke</p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full overflow-x-auto">
          <table className="w-full text-left border-collapse border border-gray-300">
            <thead className="bg-[#f3f3f3]">
              <tr>
                <th className="w-[60px] text-gray-700 border-gray-300"></th>
