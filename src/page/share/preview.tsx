		...
		<div className="select-none cursor-default">
			...
			<div className="font-noto bg-secondary_background min-h-[777px] rounded-[15px] flex justify-start w-full h-full px-[40px] mt-[25px] py-[48px] ">
				<div className="flex flex-row w-full h-full">
					<div className="flex flex-col  w-1/2 flex-shrink-0 items-start">
						<div className=" border-4 border-black p-2 aspect-[4/3] w-full max-w-[500px]">
							<img
								src={
						...
						{/* Edit Design Button */}
						<div className="mt-5 flex flex-row justify-between items-center w-full max-w-[500px]">
							...
							<tbody>
								<tr className="border border-gray-200">
									<td className="border-r border-gray-200 px-6 py-2 break-words">
										Thawatchai Wongboonsiri
									</td>
									<td className="px-6 py-2 break-words">
										thawatchai.wongb@mail.kmutt.ac.th
									</td>
								</tr>
								<tr className="border border-gray-200">
									<td className="border-r border-gray-200 px-6 py-2 break-words">
