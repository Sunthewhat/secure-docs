...
const CertificateValidationResultPage: FC = () => {
	...
	useEffect(() => {
		...
		const initCanvas = () => {
			const canvasElement = document.getElementById('validation-canvas') as HTMLCanvasElement;
			const containerElement = document.getElementById('certificate-preview');
	...
	if (isLoading) {
		return (
			<div className='select-none cursor-default'>
				...
				<div className='font-noto bg-secondary_background min-h-[777px] rounded-[15px] flex justify-center items-center w-full h-full px-[40px] mt-[25px] py-[48px]'>
